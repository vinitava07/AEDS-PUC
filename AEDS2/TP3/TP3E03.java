...
class CircularLinkList {
    ...
    public void inserirFim(Personagem pe) throws IOException {
        ...
        if (this.inicio == null) {
            ...
            this.fim.next = new Node(pe);
            this.fim = fim.next;
            this.fim.next = inicio;

        }
        // for (int j = 0; j < size; j++) {

        // total += aux.p.getAltura();
        // aux = aux.next;
        // }
        imprime();
    ...
    public void imprime() {
        ...
        media = total / (float) this.size;
        media2 = (int) media;
        if (media - (float) media2 >= 0.45) {
            media2++;
        }
