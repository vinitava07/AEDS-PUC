...
class HashReserva {
    ...
    public HashReserva(int s, int r) {
        this.maxSize = s;
        this.reserve = r;
        this.cReserve = s - r;
        p = new Personagem[s];
    ...
    public void insert(Personagem pe) {
        int hashF = pe.getAltura() % (this.maxSize - this.reserve);
        if (p[hashF] == null) {

            p[hashF] = pe.clone();
        } else if (cReserve < this.maxSize) {
...
public class TP4E5 {
    public static void main(String[] args) throws IOException {
        ...
        Personagem p = new Personagem();
        HashReserva h = new HashReserva(30, 9);
